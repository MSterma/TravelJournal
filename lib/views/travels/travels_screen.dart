...
class _TravelsMap extends StatelessWidget {
  const _TravelsMap({
...
class _TravelsControls extends StatelessWidget {
  const _TravelsControls({
...
class _TravelsDraggableSheet extends StatelessWidget {
  const _TravelsDraggableSheet({
